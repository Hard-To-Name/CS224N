...
def get_train_test_args():
    ...
    parser.add_argument('--adv-lambda', type=float, default=1e-2)
    ...
    parser.add_argument('--train-datasets', type=str, default='squad,nat_questions,newsqa,race_augmented,relation_extraction_augmented,duorc_augmented')
    ...
    parser.add_argument('--train-dir', type=str, default='datasets/all_train')
    ...
    parser.add_argument('--outdomain-data-repeat',  type=int, default=1)
    parser.add_argument('--full-adv', type=bool, default=True)
    parser.add_argument('--enable-length-loss', type=bool, default=True)
    parser.add_argument('--length-k', type=int, default=6)
    parser.add_argument('--length-lambda', type=float, default=1)
    parser.add_argument('--enable-length-bp-penalty', type=bool, default=True)
